    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex w-full">
            <div class="mb-3 w-96">
                ...
                <input class="form-input bg-slate-50 rounded-lg" type="file" id="formFile" name="profile">
        ...
        <div>
            ...
            <x-text-input id="instagram" name="instagram" type="text" class="mt-1 block w-full" :value="old('instagram', $user->instagram)" required autocomplete="instagram" />
