        ...
        <div class="max-w-screen-xl px-4 py-16 lg:py-24 mx-auto lg:px-6">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div class="group bg-slate-50 hover:bg-white max-w-sm border h-96 lg:h-auto border-gray-200 md:w-full md:max-w-none lg:p-0 lg:w-72 flex flex-col justify-evenly rounded-2xl shadow-xl shadow-blue-50">
                    ...
                    <a href="/anggota" class="inline-flex items-center px-4 py-2 text-md font-medium text-center bg-blue-600 text-white border border-gray-300 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-gray-200 mx-auto">Explore</a>
                </div>
