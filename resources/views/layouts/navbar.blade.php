        ...
        <nav
            ...
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    @else
                        <a href="/register"
                            class="hidden lg:inline-block text-blue-700 ring-2 ring-blue-600 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-4 lg:px-5 py-2 lg:py-2 sm:mr-2 lg:mr-0 focus:outline-none hover:text-white">Sign
                            Up</a>

                        <a href="/login"
                            class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none  mx-4">Log
                            in</a>
                    @endauth
                    <button id="collaps" data-collapse-toggle="mobile-menu-2" type="button"
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="/home"
                                class="block py-2 pl-3 pr-4 text-grey-700 rounded lg:bg-transparent hover:text-blue-500 @if (Request::is(['home', '/'])) text-blue-700 @endif lg:p-0"
                        ...
                        @guest
                            <li>
                                <a href="https://themesberg.com/product/tailwind-css/landing-page"
                                    class="inline-block lg:hidden w-full text-slate-800 ring-2 ring-blue-600 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm lg:px-5 px-3 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none hover:text-white">Sign
                                    Up</a>
                            </li>
                        @endguest
                    </ul>
